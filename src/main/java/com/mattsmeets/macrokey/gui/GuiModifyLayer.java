...
public class GuiModifyLayer extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawCenteredString(Minecraft.getMinecraft().fontRendererObj, !existing ? this.defaultScreenTitleText : this.editScreenTitleText, this.width / 2, 8, 16777215);
    ...
    public void initGui() {
        ...
        this.textFieldName = new GuiTextField(9, Minecraft.getMinecraft().fontRendererObj, this.width / 2 - 100, 50, 200, 20);
